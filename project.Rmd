...
Valorie Myer:
Created group chat for the group. Completed introduction. Hosted virtual meeting. Results section.
...
The mean quality scores of red and white wines is significantly different ($`r p.value.string(wine_anova_table[[1]][["Pr(>F)"]][1])`$) at the $\alpha = .05$ level.  This may make a person wonder, "How do they differ? Is white wine of better quality or is red wine of better quality?" So we ran a few *t*-tests to help us determine the relationship of the mean quality of wine. We found that the quality of red wine is not greater than that of white wine ($`r p.value.string(winequal1$p.value[1])`$).  We did find sufficient evidence to suggest that the mean quality of red wine is less than the quality of white wine at the $\alpha=0.05$ level ($`r p.value.string(winequal2$p.value[1])`$). We should run further tests to see what physiochemical properties affect the quality of wine.  We could even see what properties white wine has more or less of compared to red wine. 
### Physiochemical attributes and quality
...
$H_0:$ There is not an interaction between citric acid and volatile acidity <br> 
$H_1:$ There is an interaction between citric acid and volatile acidity

**Test Statistic**

$F_0 = `r round(wine_red_table[[1]][["F value"]][3], digits=3)`$.
...
This study of Portuguese wines shows that winemaking is both an art and a science. As vineyards strive to develop better tasting wines, they need to consider the physicochemical make-up of their product. The study found that the physicochemical properties of wine play an important part in the taste. Out of the eleven physiochemical properties studied, all but two, citric acid and chlorides, significantly predicted the quality of the wine. The data from this study showed that white wine tastes better than red wines. When we looked at how the red and white wines differed in physicochemical properties, we found that white wine has less fixed acidity, less volatile acidity (spoilage), more residual sugar, greater free sulfur dioxide, greater total sulfur dioxide, less dense, lower pH, fewer sulphates, and more alcohol. Another notable find is that these physicochemical properties don’t just impact the taste of the wines--they also impact each other, as seen by the interaction between citric acid and volatile acidity.  These are important concepts to keep in mind for large vineyards all the way to those who want to try making their own wine at home.
 
One of limitations of this study was that all the wine was from the same region of Portugal. Another limitation was that the quality variable was based on a score of small groups of judges--only 3 judges in some cases. Future studies could be done to include wines from different parts of the globe and to include a larger panel of judges.
