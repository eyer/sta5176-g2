...
briefly give meaning to your project – what is the background and why is this projectimportant?  (20 points)
...
describe the data (1st paragraph) as well as analysis results (order of results should correspondto hypotheses listed).  (20 points)

## Conclusion

restate the results in terms of the larger picture; state limitations and opportunities forfuture research (20 points)
