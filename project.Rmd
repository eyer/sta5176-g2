...
Adrienne Eddy:
Completed the methods section. Gave results for test three, four, and five
...
The multivariable ANOVA test shows that wine quality scores are significantly affected by fixed acidity, volatily acidite, residual sugar, free sulfur dioxide, total sulfur dioxide, density, pH, sulphates, and alcohol. Quality scores are not dependent on citric acid or chlorides.
